...
<div class="d-flex flex-column flex-lg-row-fluid py-10" style="background-color: #F3F4F6;">
    ...
    <div class="d-flex flex-center flex-wrap fs-6 p-5 pb-0">
        ...
        <div class="d-flex flex-center fw-semibold fs-6">
            <a href="#" class="text-muted text-hover-primary px-2" target="">About</a>
            <a href="#" class="text-muted text-hover-primary px-2" target="">Support</a>
            <a href="#" class="text-muted text-hover-primary px-2" target="">Purchase</a>
        </div>
        <!--end::Links-->
    </div>
    <!--end::Footer-->
